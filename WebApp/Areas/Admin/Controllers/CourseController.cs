...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class CourseController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Lang,Img")] CourseModel courseModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Lang,Img")] CourseModel courseModel)
        {
